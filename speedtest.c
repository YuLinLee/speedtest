...
#define SERVERS_LOCATION_REQUEST_URL "speedtest-servers.php"
...
int main() {
    ...
    if(get_ipv4_addr(SPEEDTEST_DOMAIN_NAME, &servinfo)) {
        ...
        if(!get_http_file(&servinfo, SPEEDTEST_DOMAIN_NAME, SERVERS_LOCATION_REQUEST_URL, SERVERS_LOCATION_REQUEST_URL)) {
